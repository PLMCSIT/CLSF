                ...
                <div class="col-md-4 col-sm-5">
                    <section class="upcoming-event format-standard event-list-item event-dynamic">
                        <a href="#" class="media-box">
                            <img src="/landing/images/upcoming_event.jpg" alt="">
                        </a>
                        <div class="upcoming-event-content">
                            ...
                            <h3><a href="#" class="event-title">Youth participation</a></h3>
                ...
                <div class="col-md-8 col-sm-7">
                    <div class="element-block events-listing">
                        <div class="events-listing-header">
                            <a href="{{ url('events/index') }}" class="pull-right basic-link">All Events</a>
                        ...
                        <div class="events-listing-content">
                            <div class="event-list-item event-dynamic">
                                ...
                                <div class="event-list-item-info">
                                    <div class="lined-info">
                                        <h4><a href="#" class="event-title">Water Baptism</a></h4>
                                    </div>
                                    <div class="lined-info">
                            ...
                            <div class="event-list-item event-dynamic">
                                ...
                                <div class="event-list-item-info">
                                    <div class="lined-info">
                                        <h4><a href="#" class="event-title">Sunday Meet Up</a></h4>
                                    </div>
                                    <div class="lined-info">
                            ...
                            <div class="event-list-item event-dynamic">
                                ...
                                <div class="event-list-item-info">
                                    <div class="lined-info">
                                        <h4><a href="#" class="event-title">Holy shift: Strategic think</a></h4>
                                    </div>
                                    <div class="lined-info">
                                        <span class="meta-data"><i class="fa fa-clock-o"></i> Monday, <span class="event-time">10:00 AM</span></span>
                                    </div>
