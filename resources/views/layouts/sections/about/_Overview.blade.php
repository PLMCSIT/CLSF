<div class="main" role="main">
    <div id="content" class="content full">
        <div class="container">
            <h2>Christ The Living Stone Fellowship</h2>
            <hr class="sm">
            ...
            <div class="row">
                    ...
                    <div class="grid-item staff-item format-standard">
                        <div class="grid-item-inner">
                            <a href="#" class="media-box">
                                <img src="/landing/images/staff1.jpg" alt="">
                            </a>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="grid-item staff-item format-standard">
                        <div class="grid-item-inner">
                            <a href="#" class="media-box">
                                <img src="/landing/images/staff2.jpg" alt="">
                            </a>
                            <div class="grid-content">
                                <div class="staff-item-name">
                                    <h5>Brandon Dean</h5>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="grid-item staff-item format-standard">
                        <div class="grid-item-inner">
                            <a href="#" class="media-box">
                                <img src="/landing/images/staff3.jpg" alt="">
                            </a>
                            <div class="grid-content">
                                <div class="staff-item-name">
